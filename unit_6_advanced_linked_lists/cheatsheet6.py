'''
Unit 6 Cheatsheet
Here is a helpful cheatsheet outlining common Python concepts and functions that will help you in your problem solving journey! Use this as reference as you solve the breakout problems below. This is not an exhaustive list of all Python syntax and built-in functionality; it only includes specialized syntax needed to ace Unit 6 . You will also need to know the required syntax and techniques covered in Units 1-5. In addition, by the end of this unit you should know how to:
...
Python Syntax
‼️ This material is in scope for the Unit 6 assessment.
Chained Assignment
